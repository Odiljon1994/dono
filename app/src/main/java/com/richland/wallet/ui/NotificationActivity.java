...
import com.richland.wallet.adapter.NotificationAdapter;
import com.richland.wallet.adapter.NotificationsAdapter;
import com.richland.wallet.databinding.ActivityNotificationBinding;
...
//        });
 //       binding.recyclerView.setAdapter(adapter);
        ...
        list.add(new NotificationModel.Data(1, "[공지] G3S Wallet 출시!", "1", "그들의 보내는 앞이 쓸쓸하랴? 소담스러운 청춘에서만 아니더면, 충분히 전인\n" +
                ...
                "무엇을 것이다. 영원히 따뜻한 공자는 열락의 우리의 귀는 영락과 약동하다.\u000B같이, 길을 속잎나고, 그들의 얼음과 미묘한 것이다. ", "2022.06.18T10:00 ", "2022.06.18T10:00 "));
        list.add(new NotificationModel.Data(1, "お知らせタイトル例) [お知らせ] G3S Wallet 発売!!", "1", "お知らせ内容の例)私は十一月すこぶるその相当院についてののところにあ\n" +
