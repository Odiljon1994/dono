...
import com.richland.wallet.databinding.ActivitySendBinding;
...
import com.richland.wallet.ui.dialogs.AddressesBookDialog;
...
public class SendActivity extends AppCompatActivity {
    ...
    public void currentFee(CurrentFeeModel currentFeeModel) {
        binding.currentFee.setText(String.valueOf(currentFeeModel.getFee()) + " G3S");
